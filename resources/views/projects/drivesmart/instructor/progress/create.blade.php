{{-- resources/views/projects/drivesmart/instructor/progress/create.blade.php --}}
...
>
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">New Progress Report</h1>
        ...
        <form method="POST" action="{{ route('drivesmart.instructor.progress.store') }}"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="lessons_completed" value="{{ old('lessons_completed', 0) }}" min="0" required
                           class="w-full border border-gray-300 dark:border-zinc-600 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-400">
                </div>
                <div>
            ...
            <div>
                ...
                <textarea name="notes" rows="4"
                          placeholder="Assessment notes, areas to improve, strengths…"
